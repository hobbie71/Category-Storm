      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <Section variant="bordered" className="text-center">
          ...
          <p className="text-gray-700 text-center max-w-3xl mx-auto leading-relaxed m-0">
            Students see a category on the projected screen and race to write as
            many things from that category as they can before time runs out!
          </p>
          ...
          <div className="bg-white rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
              <CategoryExample category="Animals that swim" variant="primary" />
              <CategoryExample
              ...
              <CategoryExample
                ...
                variant="primary"
              />
              <CategoryExample category="Countries in Asia" variant="accent" />
              <CategoryExample
        ...
        <Section variant="bordered">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              />
              <TipItem icon="📚" text="Customize for any academic subject" />
            </div>
          </div>
        </Section>
        ...
        <Section variant="centered">
          <div className="space-y-6">
            ...
            <p className="text-gray-500 text-lg">
              Drag this app to the projector and make it full screen after
